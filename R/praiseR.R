...
#' Deliver praise
#'
#' @description A function that praises the intended name.
#'
#' @param name This is the name of the person you want to praise. Input as text string.
#' @param punctuation This is the punctuation at the end of the praise. Default is "!".
#'
#' @return Text string with personalised praise
#' @export
#'
#' @examples
#' praise(name = "Erika", punctuation = "!")
